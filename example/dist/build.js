...
exports.default = tc.functionalComponent("VtableSplitter", {
    ...
    var className = props.ctx.draggingSplitter === props.index ? "vtable-dragging-splitter" : "vtable-splitter";
    var style = {
    ...
    var on = {
        mousedown: function mousedown(ev) {
            return props.ctx.onSplitterMouseDown(props.index, ev);
        }
    };
...
var tc = __webpack_require__(0);
var p = __webpack_require__(2);
var vlist_1 = __webpack_require__(11);
var vtablerow_1 = __webpack_require__(13);
var vtablesplitter_1 = __webpack_require__(5);
var Vtable = function (_tc$StatefulEvTypedCo) {
    _inherits(Vtable, _tc$StatefulEvTypedCo);
    ...
    _createClass(Vtable, [{
        ...
        value: function data() {
            return {
                widths: this.$props.columns.map(function (c) {
        ...
        get: function get() {
            var _$props = this.$props,
                ...
                _getRowClass = _$props.getRowClass,
                splitterWidth = _$props.splitterWidth;

            return {
                ctx: ctx,
                columns: columns,
                getRowClass: function getRowClass(item, index) {
                    return _getRowClass(item, index) || rowClass;
                },
        ...
        get: function get() {
            var _$props2 = this.$props,
                headerHeight = _$props2.headerHeight,
        ...
        get: function get() {
            ...
            return _.sumBy(this.$data.widths, function (w) {
                return w + _this3.$props.splitterWidth;
            });
        }
    }]);
...
Vtable = __decorate([tc.component(Object.assign({}, __webpack_require__(17), { components: { vlist: vlist_1.default, vtablerow: vtablerow_1.default, vtablesplitter: vtablesplitter_1.default }, props: {
        ...
        getRowClass: p.Func.Default(utils_1.supplier(function () {
            return undefined;
        })),
        ctx: p.Any,
...
/***/ (function(module, exports) {
    ...
    module.exports = {
      render: function(){with(this){return _c('div',{staticClass:"app-container"},[_c('h1',[_v(_s(message))]),_c('div',{staticStyle:{"margin-bottom":"1em"}},[_c('span',[_v(" Row height:")]),_c('input',{ref:"rowHeight",attrs:{"type":"number"},domProps:{"value":rowHeight}}),_c('span',[_v(" Row count:")]),_c('input',{ref:"rowCount",attrs:{"type":"number"},domProps:{"value":items.length}}),_c('input',{staticStyle:{"margin-left":"1em"},attrs:{"type":"button","value":"update"},on:{"click":updateParams}})]),_c('vtable',{attrs:{"id":"main-list","items":items,"row-height":rowHeight,"header-height":20,"columns":columns,"get-row-class":getRowClass,"row-style-cycle":2,"get-item-key":getItemKey,"ctx":ctx},on:{"row-click":onRowClick}})],1)}},
      staticRenderFns: []
    };
...
var App = function (_tc$TypedComponent) {
    _inherits(App, _tc$TypedComponent);
...
Object.defineProperty(exports, "__esModule", { value: true });
var resizeSensor = __webpack_require__(15);
var tc = __webpack_require__(0);
var p = __webpack_require__(2);
var utils_1 = __webpack_require__(1);
var Vlist = function (_tc$StatefulEvTypedCo) {
...
Vlist = __decorate([tc.component(Object.assign({}, __webpack_require__(16), { components: { resizeSensor: resizeSensor }, props: {
...
exports.default = tc.functionalComponent("VtableCell", {
    ...
    var column = props.ctx.columns[props.columnIndex];
    var w = utils_1.px(props.ctx.widths[props.columnIndex]);
    var style = {
        minWidth: w,
        width: w,
    ...
    return h("div", { class: ["vtable-cell", column.className], style: style }, [column.render(h, props.item, props.index, props.ctx.ctx)]);
});
...
var p = __webpack_require__(2);
var utils_1 = __webpack_require__(1);
var vtablecell_1 = __webpack_require__(12);
var vtablesplitter_1 = __webpack_require__(5);
var VtableRow = function (_tc$TypedComponent) {
...
VtableRow = __decorate([tc.component(Object.assign({}, __webpack_require__(18), { components: { vtablecell: vtablecell_1.default, vtablesplitter: vtablesplitter_1.default }, props: {
        item: p.Any.Required,
