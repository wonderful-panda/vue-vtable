...
/***/ function(module, exports, __webpack_require__) {
	...
	var vueit_1 = __webpack_require__(3);
	var vtable_1 = __webpack_require__(5);
	var columns = [{
	    title: "id",
	    className: "cell-id",
	    defaultWidth: 150,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var vtablerow_1 = __webpack_require__(13);
	...
	var Vtable = function (_Vue) {
	    ...
	    _createClass(Vtable, [{
	        ...
	        value: function onSplitterMouseDown(index, event) {
	            var _this2 = this;
	        ...
	        get: function get() {
	            ...
	            return {
	                ...
	                getRowClass: this.getRowClass ? this.getRowClass : function (item, index) {
	                    return rowClass;
	                },
	        ...
	        get: function get() {
	            ...
	            return _.sumBy(this.$data.widths, function (w) {
	                return w + _this3.splitterWidth;
	            });
	        }
	    }]);
	...
	__decorate([vueit_1.prop.required({ validator: validation_1.positive }), __metadata('design:type', Number)], Vtable.prototype, "rowHeight", void 0);
	__decorate([vueit_1.prop.default(0), __metadata('design:type', Number)], Vtable.prototype, "headerHeight", void 0);
	__decorate([vueit_1.prop.required, __metadata('design:type', Array)], Vtable.prototype, "columns", void 0);
	__decorate([vueit_1.prop.required, __metadata('design:type', Array)], Vtable.prototype, "items", void 0);
	__decorate([vueit_1.prop.default(1, { validator: validation_1.positive }), __metadata('design:type', Number)], Vtable.prototype, "rowStyleCycle", void 0);
	__decorate([vueit_1.prop.default(3, { validator: validation_1.positive }), __metadata('design:type', Number)], Vtable.prototype, "splitterWidth", void 0);
	__decorate([vueit_1.prop.default("vtable-row"), __metadata('design:type', String)], Vtable.prototype, "rowClass", void 0);
	__decorate([vueit_1.prop, __metadata('design:type', Function)], Vtable.prototype, "getRowClass", void 0);
	__decorate([vueit_1.prop, __metadata('design:type', Object)], Vtable.prototype, "ctx", void 0);
	__decorate([vueit_1.prop.required, __metadata('design:type', Function)], Vtable.prototype, "getItemKey", void 0);
	Vtable = __decorate([vueit_1.component({
	    ...
	    data: function data() {
	        return {
	            widths: this.columns.map(function (c) {
	...
	}), __metadata('design:paramtypes', [])], Vtable);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Vue = __webpack_require__(1);
	var resizeSensor = __webpack_require__(10);
	var vueit_1 = __webpack_require__(3);
	var utils_1 = __webpack_require__(8);
	var validation_1 = __webpack_require__(11);
	var Vlist = function (_Vue) {
	    ...
	    _createClass(Vlist, [{
	        ...
	        value: function onScroll(event) {
	            ...
	            var scrollLeft = _$refs$scrollable.scrollLeft;
	            var scrollTop = _$refs$scrollable.scrollTop;
	
	            var args = { scrollLeft: scrollLeft, scrollTop: scrollTop };
	        ...
	        value: function onRowClick(item, index, event) {
	            this.$emit("row-click", { item: item, index: index, event: event });
	        }
	    }, {
	        key: "onContentHeightChanged",
	        value: function onContentHeightChanged(newValue, oldValue) {
	        ...
	        value: function onContentWidthChanged(newValue, oldValue) {
	        ...
	        key: "firstIndex",
	        get: function get() {
	            var value = Math.floor(this.$data.scrollTop / this.rowHeight);
	        ...
	        get: function get() {
	            ...
	            var scrollTop = _$data.scrollTop;
	            var bodyHeight = _$data.bodyHeight;
	...
	__decorate([vueit_1.prop.required, __metadata('design:type', Object)], Vlist.prototype, "rowComponent", void 0);
	__decorate([vueit_1.prop.required, __metadata('design:type', Array)], Vlist.prototype, "items", void 0);
	__decorate([vueit_1.prop.required, __metadata('design:type', Function)], Vlist.prototype, "getItemKey", void 0);
	__decorate([vueit_1.prop({ type: [Number, String] }), __metadata('design:type', Object)], Vlist.prototype, "contentWidth", void 0);
	__decorate([vueit_1.prop, __metadata('design:type', Object)], Vlist.prototype, "ctx", void 0);
	__decorate([vueit_1.prop.required({ validator: validation_1.positive }), __metadata('design:type', Number)], Vlist.prototype, "rowHeight", void 0);
	__decorate([vueit_1.prop.default(1, { validator: validation_1.positive }), __metadata('design:type', Number)], Vlist.prototype, "rowStyleCycle", void 0);
	__decorate([vueit_1.prop, __metadata('design:type', Object)], Vlist.prototype, "style", void 0);
	__decorate([vueit_1.watch("contentHeight"), __metadata('design:type', Function), __metadata('design:paramtypes', [Object, Object]), __metadata('design:returntype', void 0)], Vlist.prototype, "onContentHeightChanged", null);
	__decorate([vueit_1.watch("contentWidth"), __metadata('design:type', Function), __metadata('design:paramtypes', [Object, Object]), __metadata('design:returntype', void 0)], Vlist.prototype, "onContentWidthChanged", null);
	Vlist = __decorate([vueit_1.component({
	    compiledTemplate: __webpack_require__(12),
	...
	}), __metadata('design:paramtypes', [])], Vlist);
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var vueit_1 = __webpack_require__(3);
	var utils_1 = __webpack_require__(8);
	var vtablecell_1 = __webpack_require__(14);
	var vtablesplitter_1 = __webpack_require__(15);
	var validation_1 = __webpack_require__(11);
	...
	__decorate([vueit_1.prop.required, __metadata('design:type', Object)], VtableRow.prototype, "item", void 0);
	__decorate([vueit_1.prop.required({ validator: validation_1.notNegative }), __metadata('design:type', Number)], VtableRow.prototype, "index", void 0);
	__decorate([vueit_1.prop.required({ validator: validation_1.positive }), __metadata('design:type', Number)], VtableRow.prototype, "height", void 0);
	__decorate([vueit_1.prop.required, __metadata('design:type', Object)], VtableRow.prototype, "ctx", void 0);
	...
	}), __metadata('design:paramtypes', [])], VtableRow);
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var vueit_1 = __webpack_require__(3);
	var utils_1 = __webpack_require__(8);
	var VtableCell = function (_Vue) {
	    _inherits(VtableCell, _Vue);
	
	    function VtableCell() {
	        _classCallCheck(this, VtableCell);
	
	        return _possibleConstructorReturn(this, (VtableCell.__proto__ || Object.getPrototypeOf(VtableCell)).apply(this, arguments));
	    }
	
	    _createClass(VtableCell, [{
	        key: "render",
	        value: function render(h, context) {
	            var column = this.ctx.columns[this.columnIndex];
	            var w = utils_1.px(this.ctx.widths[this.columnIndex]);
	            var style = {
	                minWidth: w,
	                width: w,
	                lineHeight: utils_1.px(this.height),
	            ...
	            return h("div", { class: ["vtable-cell", column.className], style: style }, [column.render(h, this.item, this.index, this.ctx.ctx)]);
	        }
	    }]);
	
	    return VtableCell;
	}(Vue);
	__decorate([vueit_1.prop.required, __metadata('design:type', Object)], VtableCell.prototype, "item", void 0);
	__decorate([vueit_1.prop.required, __metadata('design:type', Number)], VtableCell.prototype, "index", void 0);
	__decorate([vueit_1.prop.required, __metadata('design:type', Number)], VtableCell.prototype, "columnIndex", void 0);
	__decorate([vueit_1.prop.required, __metadata('design:type', Number)], VtableCell.prototype, "height", void 0);
	__decorate([vueit_1.prop.required, __metadata('design:type', Object)], VtableCell.prototype, "ctx", void 0);
	VtableCell = __decorate([vueit_1.functionalComponent, __metadata('design:paramtypes', [])], VtableCell);
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var vueit_1 = __webpack_require__(3);
	var utils_1 = __webpack_require__(8);
	var vtablesplitter = function (_Vue) {
	    _inherits(vtablesplitter, _Vue);
	
	    function vtablesplitter() {
	        _classCallCheck(this, vtablesplitter);
	
	        return _possibleConstructorReturn(this, (vtablesplitter.__proto__ || Object.getPrototypeOf(vtablesplitter)).apply(this, arguments));
	    }
	
	    _createClass(vtablesplitter, [{
	        key: "render",
	        value: function render(h, context) {
	            var _this2 = this;
	
	            var className = this.ctx.draggingSplitter === this.index ? "vtable-dragging-splitter" : "vtable-splitter";
	            var style = {
	            ...
	            var on = {
	                mousedown: function mousedown(ev) {
	                    return _this2.ctx.onSplitterMouseDown(_this2.index, ev);
	                }
	            };
	            return h("div", { class: className, style: style, on: on });
	        }
	    }]);
	
	    return vtablesplitter;
	}(Vue);
	__decorate([vueit_1.prop.required, __metadata('design:type', Number)], vtablesplitter.prototype, "index", void 0);
	__decorate([vueit_1.prop.required, __metadata('design:type', Object)], vtablesplitter.prototype, "ctx", void 0);
	vtablesplitter = __decorate([vueit_1.functionalComponent, __metadata('design:paramtypes', [])], vtablesplitter);
	Object.defineProperty(exports, "__esModule", { value: true });
